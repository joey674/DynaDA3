...
CONFIG = {
    # Data Configuration
    "video_dirs": [
        "../dataset_dynada3_train/dancer",
        "../dataset_dynada3_train/wildgs_ANYmal1",
        "../dataset_dynada3_train/wildgs_ANYmal2",
        "../dataset_dynada3_train/wildgs_ANYmal3",
        "../dataset_dynada3_train/wildgs_racket1",
        "../dataset_dynada3_train/wildgs_racket2",
...
def train():
    ...
    model = DynaDA3(model_name=CONFIG["model_name"]).to(device)
    model.train()
